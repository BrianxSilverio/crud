...
<html>
<head>
	<title>University Crud Admin Page</title>
	<meta charset="utf-8">
...
<br>
	<div class="container">
<center><a href="https://plmun.edu.ph/student-portal/system/main/" target="_blank"><img src="../student-registration/logo.png" alt="University" width="150px"></a></center>
...
<input type="submit" name="export" class="btn btn-primary pull-right" value="Export Data"/>
</form>
	<a href="logout.php" class="btn btn-info"><i class="fa fa-lock"></i>  Logout</a>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<center><img src="../student-registration/logo.png" width="200px" height="80px" alt=""></center>
...
<input type="text" class="form-control" name="card_no" placeholder="Enter 7-digit Student ID" maxlength="7" required>
</div>
<div class="form-group col-md-6">
...
<div class="form-group col-md-6">
<label for="aadharno">Emergency Contact No.</label>
<input type="text" class="form-control" name="user_aadhar" maxlength="11" placeholder="Enter 11-digit Contact No. ">
</div>
</div>
...
<div class="form-group">
<label for="inputAddress">Block/Lot/House No., Street, Subdivision, Village</label>
<input type="text" class="form-control" name="village" placeholder="1234 Main St">
</div>
<div class="form-group">
<label for="inputAddress2">Municipality</label>
<input type="text" class="form-control" name="police_station" placeholder="City">
</div>
<div class="form-row">
<div class="form-group col-md-6">
...
<select name="state" class="form-control">
  ...
  <option value="ABR">Abra</option>
    ...
    <option value="14">Autonomous Region in Muslim Mindanao</option>
    ...
    <option value="05">Bicol Region</option>
    ...
    <option value="02">Cagayan Valley</option>
    <option value="40">Calabarzon</option>
    ...
    <option value="07">Central Visayas</option>
    <option value="COM">Compostela Valley</option>
    <option value="15">Cordillera Administrative Region</option>
    ...
    <option value="41">Mimaropa</option>
...
<div class="form-group">
<label for="inputAddress">Staff ID who adds this student</label>
<input type="text" class="form-control" name="staff_id" maxlength="7" placeholder="Enter 7-digit Staff ID">
</div>
...
<div id='$id' class='modal fade' role='dialog'>
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      <div class='modal-header'>
        <button type='button' class='close' data-dismiss='modal'>&times;</button>
        <h4 class='modal-title text-center'>Are you sure you want to delete this one?</h4>
      </div>
      <div class='modal-body'>
			...
			<div class='container' id='profile'> 
				<div class='row'>
					...
					<div class='col-sm-3 col-md-6'>
						...
						<strong>Emergency Contact No.:</strong> $aadhar <br>
  ...
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      ...
      <div class='modal-body'>
		...
		<div class='form-group col-md-6'>
		<label for='inputEmail4'>Student ID</label>
		<input type='text' class='form-control' name='card_no' placeholder='Enter 7-digit Student ID' maxlength='7' value='$card' required>
		</div>
		<div class='form-group col-md-6'>
		<label for='inputPassword4'>Mobile No.</label>
		...
		<div class='form-group col-md-6'>
		<label for='aadharno'>Emergency Contact No.</label>
		<input type='text' class='form-control' name='user_aadhar' maxlength='11' placeholder='Enter 11-digit Contact No. ' value='$aadhar'>
		</div>
		</div>
		...
		<div class='form-group'>
		<label for='inputAddress2'>Municipality</label>
		<input type='text' class='form-control' name='police_station' placeholder='City' value='$police'>
		</div>
		<div class='form-row'>
		<div class='form-group col-md-6'>
		<label for='inputCity'>District</label>
		...
		<div class='form-group'>
		<label for='inputAddress'>Staff ID who activates this card</label>
		<input type='text' class='form-control' name='staff_id' maxlength='7' placeholder='Enter 7-digit Staff ID' value='$staffCard'>
		</div>
